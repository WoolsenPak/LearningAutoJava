package ru.homeWork.mySecondHW.api.cats;
...
public class ApiTest {
    ...
    @Test(priority = 1)
    public void apiDeleteAllCatTest() {
        StatusDto statusDeleteAllCat = catConnector.deleteAllCats();
    ...
    @Test(priority = 2)
    public void apiGenerateNewCatsTest() {
        List<CatDto> catList = catConnector.generateNewCats();
    ...
    public void apiAvailableCatInListTest() {
        ...
        assertThat(catNameList)
                .as("Check available expected cat")
